...
Version  : 3.3
Release  : 23
URL      : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.3.tar.gz
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.3.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.3
cd %{_builddir}/trace-cmd-v3.3
pushd ..
cp -a trace-cmd-v3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722281495
