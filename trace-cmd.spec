...
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.2.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.1.2
cd %{_builddir}/trace-cmd-v3.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657839923
...
cp %{_builddir}/trace-cmd-v3.1.2/COPYING %{buildroot}/usr/share/package-licenses/trace-cmd/29156b719d2cbb6630525c4f4d4a4657ef76649a
cp %{_builddir}/trace-cmd-v3.1.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/trace-cmd/1927bd74419ad757a1d8e010f558c162bc7a4721
