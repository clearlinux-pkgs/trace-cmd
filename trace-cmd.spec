...
Version  : 3.1.4
Release  : 19
URL      : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.4.tar.gz
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.4.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.1.4
cd %{_builddir}/trace-cmd-v3.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664428520
...
/usr/lib64/libtracecmd.so.1.2.0
