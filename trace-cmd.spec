...
Version  : 3.1
Release  : 15
URL      : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.tar.gz
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.1
cd %{_builddir}/trace-cmd-v3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653338603
...
cp %{_builddir}/trace-cmd-v3.1/COPYING %{buildroot}/usr/share/package-licenses/trace-cmd/29156b719d2cbb6630525c4f4d4a4657ef76649a
cp %{_builddir}/trace-cmd-v3.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/trace-cmd/1927bd74419ad757a1d8e010f558c162bc7a4721
