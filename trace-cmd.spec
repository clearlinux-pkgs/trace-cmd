...
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.3.2.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.3.2
cd %{_builddir}/trace-cmd-v3.3.2
pushd ..
cp -a trace-cmd-v3.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745276195
