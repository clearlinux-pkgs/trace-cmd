...
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.5.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.1.5
cd %{_builddir}/trace-cmd-v3.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670895769
...
/usr/lib64/libtracecmd.so.1.3.0
