...
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.6.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.1.6
cd %{_builddir}/trace-cmd-v3.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673372257
...
/usr/lib64/libtracecmd.so.1.3.1
