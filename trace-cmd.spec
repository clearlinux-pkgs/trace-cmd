...
Source0  : https://git.kernel.org/pub/scm/utils/trace-cmd/trace-cmd.git/snapshot/trace-cmd-v3.1.3.tar.gz
...
%prep
%setup -q -n trace-cmd-v3.1.3
cd %{_builddir}/trace-cmd-v3.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664148907
